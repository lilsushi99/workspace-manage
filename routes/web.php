...
use App\Http\Controllers\Reseller\BankAccountController as ResellerBankAccountController;
...
Route::middleware('auth')->group(function () {
    ...
    // Reseller Management Routes (Requires complete onboarding)
    Route::middleware([EnsureOnboardingIsComplete::class])->prefix('reseller')->name('reseller.')->group(function () {
        ...
        Route::get('/banks', [ResellerBankAccountController::class, 'index'])->name('banks.index');
        Route::get('/banks/create', [ResellerBankAccountController::class, 'create'])->name('banks.create');
        Route::post('/banks', [ResellerBankAccountController::class, 'store'])->name('banks.store');
        Route::post('/banks/{bankAccount}/default', [ResellerBankAccountController::class, 'setDefault'])->name('banks.default');

        Route::get('/wallet', [ResellerWithdrawalController::class, 'wallet'])->name('wallet.index');
        Route::get('/wallet/withdraw', [ResellerWithdrawalController::class, 'create'])->name('wallet.withdraw');
        Route::post('/wallet/withdraw', [ResellerWithdrawalController::class, 'store'])->name('wallet.withdraw.store');
    });
